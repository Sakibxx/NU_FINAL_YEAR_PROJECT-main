...
# class MultiimagesQuestion(models.Model):
...
class NuQuestion(models.Model):
    ...
    question_image = models.ImageField(upload_to='question_image', blank=True)
    pdf = models.FileField(upload_to='nu_question', blank=True)
